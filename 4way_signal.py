...
# Green light Right
green_light_right = turtle.Turtle()
green_light_right.shape("circle")
green_light_right.color("grey")
green_light_right.penup()
green_light_right.goto(40, 220)

# Green light Left
green_light_left = turtle.Turtle()
green_light_left.shape("circle")
green_light_left.color("grey")
green_light_left.penup()
green_light_left.goto(-40, 220)
...
# Green light Right
green_light1_right = turtle.Turtle()
green_light1_right.shape("circle")
green_light1_right.color("grey")
green_light1_right.penup()
green_light1_right.goto(-250, -40)

# Green light left
green_light1_left = turtle.Turtle()
green_light1_left.shape("circle")
green_light1_left.color("grey")
green_light1_left.penup()
green_light1_left.goto(-330, -40)
...
# Green light Right
green_light2_right = turtle.Turtle()
green_light2_right.shape("circle")
green_light2_right.color("grey")
green_light2_right.penup()
green_light2_right.goto(330, -40)

# Green light Left
green_light2_left = turtle.Turtle()
green_light2_left.shape("circle")
green_light2_left.color("grey")
green_light2_left.penup()
green_light2_left.goto(250, -40)
...
# Green light Right
green_light3_right = turtle.Turtle()
green_light3_right.shape("circle")
green_light3_right.color("grey")
green_light3_right.penup()
green_light3_right.goto(40, -290)

# Green light Left
green_light3_left = turtle.Turtle()
green_light3_left.shape("circle")
green_light3_left.color("grey")
green_light3_left.penup()
green_light3_left.goto(-40, -290)
...
# Lane1
    ...
    green_light_right.color("green")
    green_light_left.color("green")
    green_light1_left.color("green")
    green_light2_left.color("green")
    green_light3_left.color("green")
    green_light1.color("grey")
    green_light2.color("grey")
    green_light3.color("grey")
...
# Lane2
    ...
    green_light1_right.color("green")
    green_light1_left.color("green")
    green_light_left.color("green")
    green_light2_left.color("green")
    green_light3_left.color("green")
...
# Lane3
    ...
    green_light2_left.color("green")
    green_light2_right.color("green")
    green_light_left.color("green")
    green_light1_left.color("green")
    green_light3_left.color("green")
    green_light3.color("grey")
...
# Lane4
    ...
    green_light3_left.color("green")
    green_light3_right.color("green")
    green_light_left.color("green")
    green_light1_left.color("green")
    green_light2_left.color("green")
